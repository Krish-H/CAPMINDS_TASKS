...
This is a complete REST API built using Core PHP, following the MVC architecture. It features a secure Dual-Token (JWT Access + HttpOnly Refresh) authentication architecture, password hashing, and middleware route protection with strict data isolation.
...
- **Response (200 OK):**
  ...
  ```
  *Note: A `Set-Cookie: refresh_token=...; HttpOnly; SameSite=Strict` header is also sent.*
