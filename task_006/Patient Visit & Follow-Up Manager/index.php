            ...
            <div class="card-body p-0">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div>
                            <a href="patients/view.php?id=<?= $rv['patient_id'] ?>" class="text-decoration-none fw-bold">
        ...
        <div class="card h-100">
            ...
            <div class="card-body p-0">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div>
                            <a href="patients/view.php?id=<?= $rp['patient_id'] ?>" class="text-decoration-none fw-bold">
