                ...
                <ul class="list-group list-group-flush">
                    ...
                    <?php else: ?>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <a href="../patients/view.php?id=<?= $ub['patient_id'] ?>" class="text-decoration-none fw-bold">
            ...
            <div class="card-body p-0">
                <ul class="list-group list-group-flush">
                    ...
                    <?php else: ?>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                <a href="../patients/view.php?id=<?= $mb['patient_id'] ?>" class="text-decoration-none fw-bold">
