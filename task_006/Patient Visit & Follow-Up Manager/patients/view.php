...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-end">
        <a href="edit.php?id=<?= encode_id($patient_id) ?>" class="btn btn-secondary"><i class="bi bi-pencil"></i> Edit</a>
        <a href="../visits/add.php?patient_id=<?= encode_id($patient_id) ?>" class="btn btn-primary"><i class="bi bi-calendar-plus"></i> New Visit</a>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="text-end">
            <a href="../visits/patient_visits.php?id=<?= encode_id($patient_id) ?>" class="btn btn-sm btn-outline-primary">View Full Visit History</a>
        </div>
    </div>
</div>
