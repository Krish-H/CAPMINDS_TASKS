        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="view.php?id=<?= encode_id($p['patient_id']) ?>" class="btn btn-sm btn-outline-primary" title="View"><i class="bi bi-eye"></i></a>
                        <a href="edit.php?id=<?= encode_id($p['patient_id']) ?>" class="btn btn-sm btn-outline-secondary" title="Edit"><i class="bi bi-pencil"></i></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
