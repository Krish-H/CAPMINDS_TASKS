        ...
        <tbody>
            ...
            <?php else: ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../patients/view.php?id=<?= encode_id($v['patient_id']) ?>" class="text-decoration-none fw-bold">
                    ...
                    <td>
                        <a href="patient_visits.php?id=<?= encode_id($v['patient_id']) ?>" class="btn btn-sm btn-outline-secondary" title="View Patient History"><i class="bi bi-clock-history"></i> History</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php endif; ?>
