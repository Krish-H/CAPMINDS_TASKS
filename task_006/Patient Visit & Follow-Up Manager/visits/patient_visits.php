...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-end">
        <a href="../patients/view.php?id=<?= $patient_id ?>" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back to Patient</a>
        <a href="add.php?patient_id=<?= $patient_id ?>" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Add Visit</a>
    </div>
</div>
